...
public class AbyssfallHUD : MonoBehaviour
{
    ...
    {
#if UNITY_EDITOR
        if (frameSprite == null) frameSprite = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Sprites/HUD_Bar_Frame.png");
        if (hpFillSprite == null) hpFillSprite = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Sprites/HUD_Bar_Fill_Red.png");
        if (manaFillSprite == null) manaFillSprite = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Sprites/HUD_Bar_Fill_Blue.png");
        if (staminaFillSprite == null) staminaFillSprite = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Sprites/HUD_Bar_Fill_Stamina.png");
#endif
    }
